...
/obj/item/weapon/gun/energy/excursion
	...
	icon = 'icons/obj/gun_blasters.dmi'
	icon_state = "energy"
...
/obj/item/weapon/gun/energy/excursion/pistol
	...
	desc = "A prototype energy pistol, based on recovered alien technology. Like standard expedition weaponry, it includes a station-lock system. Unlike the phaser rifles, it instead overheats and gradually cools down over time. It is capable of single shot and somewhat inaccurate two-shot burst modes. It has the fastest recharge time of the prototypes."
	icon_state = "pistol_semi100"
	item_state = "phase"
	fire_sound = 'sound/weapons/blaster.ogg'
	w_class = ITEMSIZE_SMALL
	fire_delay = 12
	recharge_time = 3 //base recharge
	charge_delay = 25 //short delay
	accuracy = 0 //no accuracy mod
	modifystate = "pistol_semi"

	projectile_type = /obj/item/projectile/beam/excursion/pistol_semi
	firemodes = list(
		list(mode_name="semi-auto", burst=1, fire_delay=12, projectile_type=/obj/item/projectile/beam/excursion/pistol_semi, modifystate = "pistol_semi", charge_cost = 400),
		list(mode_name="two-shot burst", burst=2, fire_delay=null, move_delay=4, burst_accuracy=list(-10,-15), dispersion=list(0.0, 0.2), projectile_type=/obj/item/projectile/beam/excursion/pistol_burst, modifystate = "pistol_burst", charge_cost = 300),
	)
